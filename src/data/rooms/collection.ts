...
// Room 01 — The Collection. Composed by hand; see the rules in layout.ts.
export const COLLECTION_ROOM: RoomLayout = {
  id: "collection",
  name: "The Collection",
  line: "Everything I saved from the internet. None of it is mine. All of it is me.",
  headline: [
