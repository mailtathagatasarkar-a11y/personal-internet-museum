...
export const OBJECTS: MuseumObject[] = [
  ...
  },
  {
    ...
    relations: [
      ...
      { to: "univers", kind: "SAME IDEA", why: "Both were built as systems: the Alto's windows and the grid of a type family." },
    ],
  },
  {
    id: "game-boy",
...
// Objects referenced in relations that are not on view get dropped silently.
const IDS = new Set(OBJECTS.map((o) => o.id));
for (const o of OBJECTS) o.relations = o.relations.filter((r) => IDS.has(r.to));
